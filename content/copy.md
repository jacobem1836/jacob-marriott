# Website copy – final Stage 2 draft

Tone: prose-first, confident, software-professional. Mono (Geist Mono) used for section numbers, tags, and backtick highlights only.

---

## `01 / intro` – Hero

**Jacob Marriott – software engineering student at UQ, building software that ships.**
...
### `work / 01` – Chef Jon Pizzeria Dashboard · shipped, in production
...
`next.js` `supabase` `postgres` `chart.js` `vercel`

### `work / 02` – Vinyl Scraper · personal, running
...
`python` `fastapi` `sqlalchemy` `railway`

### `work / 03` – dAIly · in progress
...
`python` `langgraph` `pgvector` `fastapi`

---

## `04 / experience`

**Contract Software Engineer** · Brisbane, QLD · *Mar 2026 – present*
...
**Chef de Partie** · Chef Jon Pizzeria & Bistro, Brisbane · *Aug 2025 – present*
Bistro section lead. POS programming bridging FOH/BOH – which is what started the dashboard work.

**Chef de Partie** · Boucher French Bistro, Brisbane · *Dec 2025 – present*

**Commis Chef** · Ruby, My Dear, Brisbane · *Jan – Aug 2025*
Menu development, independent prep operations.

**Commis Chef** · Tanoshi Restaurant Group, Queenstown NZ · *Nov 2021 – Dec 2025*
Traditional Japanese technique, precision and timing, training junior staff.

**Sound Engineer (Contract)** · Rock Formation Trust, Queenstown NZ · *Nov 2020 – Dec 2022*

[**download full CV** →](/cv.pdf)

*Layout: mono dates left column, prose right. Hairline rule between entries.*

---

## `05 / contact`

The shortest path is email. Phone if it's urgent. LinkedIn if you want the CV alongside a face.

- **email** – [jacobemarriott@icloud.com](mailto:jacobemarriott@icloud.com)
- **phone** – click to reveal · AU +61 424 964 420 · NZ +64 21 026 71274
- **linkedin** – [jacob-marriott](https://www.linkedin.com/in/jacob-marriott-1836-98a6571aa)
- **github** – [jacobem1836](https://github.com/jacobem1836)
